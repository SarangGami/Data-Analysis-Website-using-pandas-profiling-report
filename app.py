...
img = Image.open(r"C:\Users\lenovo\Desktop\eda_web/web_logo.png")
...
st.markdown(
    """
    <div style='text-align:center; background-color:#E1FAFF; padding: 20px'>
        <h1>The EDA-Analysis</h1>
        <h3>Exploratory Data Analysis with pandas-profiling</h3>
        <div style='background-color:#ACDDDE; padding: 10px'>
...
if uploaded_file is not None:
    ...
    if st.button('Press to use Example Dataset'):
        st.markdown(
            """
            <div style='background-color: #7BF1A8; padding: 10px; margin-top: 5px;'>
